...
const coachLink = 'https://forms.office.com/e/gm5WmeA1JP'
const statisticsLink = 'https://forms.office.com/e/hDDKHBwV8r'
...
const SportsCoachUI = ({ recommendedSport, preferences, topTags }) => {
	...
	useEffect(() => {
		...
		I recommend ${recommendedSport.sport} because it matches best with these tags from your preferences: ${topTags.map(t => `'${t[0]}'`).join(', ')}.`
